...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PA10     ------> USART1_RX
    */
    GPIO_InitStruct.Pin = uart1_Base_TX_Pin|uart1_Base_RX_Pin;
  ...
  */
    ...
    PA3     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = uart2_Debug_TX_Pin|uart2_Debug_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  ...
  */
    ...
    PD9     ------> USART3_RX
    */
    GPIO_InitStruct.Pin = do_485_Dir_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
    HAL_GPIO_Init(do_485_Dir_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = uart3_485_TX_Pin|uart3_485_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART3;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PA3     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOA, uart2_Debug_TX_Pin|uart2_Debug_RX_Pin);
  ...
  /* USER CODE END USART3_MspDeInit 0 */
    ...
    PD9     ------> USART3_RX
    */
    HAL_GPIO_DeInit(do_485_Dir_GPIO_Port, do_485_Dir_Pin);

    HAL_GPIO_DeInit(GPIOD, uart3_485_TX_Pin|uart3_485_RX_Pin);
